                ...
                <?php if ($_GET['respuesta'] == "correcto") { ?>
                    <div class="alert alert-success alert-dismissible">
                        ...
                        <?php if ($_GET['action'] == "create") { ?>
                            la persdona ha sido creada con exito!
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <?php if ($persona->getEstado() != "Activo") { ?>
                                                            <a href="../../../app/controllers/personacontrollers.php?action=activate&Id=<?php echo $persona->getId(); ?>"
                                                               type="button" data-toggle="tooltip" title="Activar"
                                                               class="btn docs-tooltip btn-success btn-xs"><i
                                                                        class="fa fa-check-square"></i></a>
                                                        <?php } else { ?>
                                                            <a type="button"
                                                               href="../../../app/controllers/personacontrollers.php?action=inactivate&Id=<?php echo $persona->getId(); ?>"
