...
use app\controllers\personacontrollers; ?>
<!DOCTYPE html>
<html>
<head>
                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="<?= $baseURL; ?>/views/">SIGA_SanRafael</a></li>
                    ...
                    <div class="row">
                        <div class="col">
                            <table id="tblpersona" class="datatable table table-bordered table-striped">
                                ...
                                <tbody>
                                <?php
                                $arrpersona = personacontrollers::getAll();
                                foreach ($arrpersona as $persona){
                                    ?>
                                    <tr>
                                        <td><?php echo $persona->getid_persona(); ?></td>
                                        ...
                                        <td><?php echo $persona->getcorreol(); ?></td>
                                        ...
                                        <td>
                                            ...
                                            <?php if ($persona->getEstado() != "Activo"){ ?>
                                                <a href="../../../app/controllers/personacontrollers.php?action=activate&Id=<?php echo $persona->getId(); ?>" type="button" data-toggle="tooltip" title="Activar" class="btn docs-tooltip btn-success btn-xs"><i class="fa fa-check-square"></i></a>
                                            <?php }else{ ?>
                                                <a type="button" href="../../../app/controllers/personacontrollers.php?action=inactivate&Id=<?php echo $persona->getid_persona(); ?>" data-toggle="tooltip" title="Inactivar" class="btn docs-tooltip btn-danger btn-xs"><i class="fa fa-times-circle"></i></a>
                                            <?php } ?>
                                        </td>
                                    </tr>
                                <?php } ?>
