...
require("../../../app/controllers/personacontrollers.php");
                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="<?= $baseURL; ?>/views/">SIGA-San_Rafael</a></li>
            ...
            <div class="card card-info">
                ...
                <?php if(!empty($_GET["id"]) && isset($_GET["id"])){ ?>
                    ...
                    if(!empty($Datapersona)){
                        ?>
                        <!-- form start -->
                        <form class="form-horizontal" method="post" id="frmEditUsuario" name="frmEditUsuario" action="../../../app/controllers/personacontrollers.php?action=edit">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input required type="text" class="form-control" id="correo" name="correo" value="<?= $Datapersona->getcorreo(); ?>" placeholder="Ingrese su correo">
                                    </div>
                                </div>
                                <div class="form-group row">
